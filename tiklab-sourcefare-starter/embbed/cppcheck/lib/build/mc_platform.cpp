...
#include <string>
#include <cstring>
#line 1 "/opt/cppcheck/cppcheck-main/lib/platform.cpp"
/*
...
{
    if (platformstr == MatchCompiler::makeConstString("win32A"))
        set(Type::Win32A);
    else if (platformstr == MatchCompiler::makeConstString("win32W"))
        set(Type::Win32W);
    else if (platformstr == MatchCompiler::makeConstString("win64"))
        set(Type::Win64);
    else if (platformstr == MatchCompiler::makeConstString("unix32"))
        set(Type::Unix32);
    else if (platformstr == MatchCompiler::makeConstString("unix64"))
        set(Type::Unix64);
    else if (platformstr == MatchCompiler::makeConstString("native"))
        set(Type::Native);
    else if (platformstr == MatchCompiler::makeConstString("unspecified"))
