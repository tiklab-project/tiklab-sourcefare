...
#include <string>
#include <cstring>
#line 1 "/opt/cppcheck/cppcheck-main/lib/mathlib.cpp"
/*
...
template<> std::string MathLib::toString<double>(double value)
{
    ...
    if (s == MatchCompiler::makeConstString("-0"))
        return "0.0";
...
static std::string intsuffix(const std::string & first, const std::string & second)
{
    ...
    if (suffix1 == MatchCompiler::makeConstString("ULL") || suffix2 == MatchCompiler::makeConstString("ULL"))
        return "ULL";
    if (suffix1 == MatchCompiler::makeConstString("LL") || suffix2 == MatchCompiler::makeConstString("LL"))
        return "LL";
    if (suffix1 == MatchCompiler::makeConstString("UL") || suffix2 == MatchCompiler::makeConstString("UL"))
        return "UL";
    if (suffix1 == MatchCompiler::makeConstString("L") || suffix2 == MatchCompiler::makeConstString("L"))
        return "L";
    if (suffix1 == MatchCompiler::makeConstString("U") || suffix2 == MatchCompiler::makeConstString("U"))
        return "U";
