...
rem    start /b .\java.exe %JAVA_OPTS% -classpath "%CLASSPATH%" %APP_MAIN% >> "%DIRS%logs\app.log"
    start /b .\java.exe %JAVA_OPTS% -classpath "%CLASSPATH%" %APP_MAIN% > nul 2>&1'
...
if %PID%==0 (
    ...
    echo ================================================================================================================
    echo "%APP_MAIN% START SUCCESS(PID=%PID%)"
)
