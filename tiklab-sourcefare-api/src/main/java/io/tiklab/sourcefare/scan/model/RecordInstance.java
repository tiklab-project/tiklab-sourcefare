...
@Join
@Mapper
public class RecordInstance implements Serializable {
    ...
    @ApiProperty(name="ruleType",desc="扫描规则类型 规范：norm、功能：function、安全：security")
    private String ruleType;

    @ApiProperty(name="state",desc="状态 0 未处理、1处理")
    private Integer state=0;

    @ApiProperty(name="problemLevel",desc="问题等级 严重:1、错误：2、警告：3、建议:4")
